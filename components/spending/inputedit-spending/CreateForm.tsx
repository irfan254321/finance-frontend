 ...
 * @description Component for creating new spending entries.
 */
...
interface CreateFormProps {
  ...
  handleSubmitSpending: (e: React.FormEvent) => void;
  categories: any[];
  medicines: any[];
  handleMedicineChange: (index: number, field: any, val: string) => void;
  addMedicine: () => void;
      ...
      setTimeout(async () => {
        try {
          const res = await axiosInstance.get(
            `/api/CompanyMedicine?search=${keyword}`
          );
        ...
        <CustomTextField
          ...
          value={
            isObat
              ...
              ? `Rp ${formatRupiah(Number(form.amount_spending))}`
              : ""
          }
