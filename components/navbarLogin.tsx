...
export default function NavbarAdmin() {
  ...
  const { user, logout, isLogoutLoading, setIsLogoutLoading } = useAuth();
        ...
        <div className="hidden md:flex items-center space-x-36 text-2xl relative mt-9 mr-72">
          ...
          <div className="relative">
            <button
              ...
              className={`relative group px-2 font-semibold cursor-pointer ${openMenu === "manage"
                ? "text-[#FFD970] drop-shadow-[0_0_6px_rgba(255,217,112,0.4)]"
                : "text-[#EBD77A]"
                }`}
            >
                                ...
                                >
                                  <AnimatePresence mode="wait">
                                    {isLogoutLoading ? (
                                      ...
                                      >
                                        <motion.div
                                          className="w-4 h-4 border-2 border-[#FFD700] border-t-transparent rounded-full animate-spin"
                                        />
                                        LOGGING OUT...
                                      </motion.div>
                                    ) : (
