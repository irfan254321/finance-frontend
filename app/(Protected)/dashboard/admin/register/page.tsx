...
export default function RegisterPage() {
  ...
  return (
    <div className="relative">
      {/* LAYER BACKGROUND: full screen di belakang navbar */}
      <div className="fixed inset-0 -z-10 bg-gradient-to-br from-[#0C1220] via-[#182236] to-[#0C1220] overflow-hidden">
      ...
      {/* LAYER KONTEN: mulai di bawah navbar */}
      <div className=" min-h-screen flex items-center justify-center">
        <motion.form
          initial={{ opacity: 0 }}           // (opsional) buang y:40 biar center perfect
          animate={{ opacity: 1 }}
