    ...
    <div className="min-h-screen bg-gradient-to-br from-[#1a2732] via-[#2C3E50] to-[#1a2732] text-[#EBD77A] p-8 pt-24 font-serif">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        >
          <Typography
            variant="h3"
            className="font-bold text-[#EBD77A] drop-shadow-lg"
          >
            📅 Kelola Tahun
          </Typography>
          ...
          <Paper className="p-6 !bg-[#1a2732]/80 border border-[#EBD77A]/20 rounded-xl shadow-xl backdrop-blur-sm">
            <form onSubmit={handleAddYear} className="flex gap-4 items-center">
              <TextField
                ...
                InputProps={{
                  className: "!text-[#FFD970] !border-[#EBD77A]/30",
                }}
                sx={{
                  // label
                  "& .MuiInputLabel-root": {
                    color: "rgba(235, 215, 122, 0.7)",
                  },
                  "& .MuiInputLabel-root.Mui-focused": { color: "#FFD970" },

                  // input container
                  "& .MuiOutlinedInput-root": {
                    backgroundColor: "rgba(26, 39, 50, 0.55)", // ✅ ini yang bikin ga putih
                    color: "#FFD970",
                    borderRadius: "12px",
        ...
        >
          <TableContainer
            component={Paper}
            className="!bg-[#1a2732]/80 !border !border-[#EBD77A]/20 !rounded-xl !shadow-xl !backdrop-blur-sm"
          >
            <Table>
              <TableHead className="bg-[#2C3E50]/50">
                <TableRow>
                  <TableCell className="!text-[#EBD77A] !font-bold !text-lg">
                    No
                  </TableCell>
                  <TableCell className="!text-[#EBD77A] !font-bold !text-lg">
                    Tahun
                  ...
                  <TableCell
                    align="right"
                    className="!text-[#EBD77A] !font-bold !text-lg"
                  >
                    Aksi
                  </TableCell>
                </TableRow>
                ...
                {loading ? (
                  ...
                  <TableRow>
                    <TableCell
                      colSpan={3}
                      align="center"
                      className="!text-[#F4E1C1]/60 !py-8 !italic"
                    >
                  ...
                  years.map((row, index) => (
                    ...
                    >
                      <TableCell className="!text-[#F4E1C1]">
                        {index + 1}
                      </TableCell>
