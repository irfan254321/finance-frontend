...
export default function DashboardPage() {
  return (
    <main className="relative px-6 md:px-20 py-20 font-serif text-[#ECECEC] leading-relaxed min-h-screen bg-gradient-to-b from-[#0f141a]/70 via-[#1c2430]/80 to-[#12171d]/90 backdrop-blur-xl">
      {/* ===== HERO INTRO ===== */}
